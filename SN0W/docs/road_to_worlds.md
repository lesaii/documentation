...
First things first, **Load up a Unity Project via [ALCOM](https://vrc-get.anatawa12.com/en/alcom) or [VCC](https://vcc.docs.vrchat.com) and [Install the Pro Builder plugin](https://www.youtube.com/watch?v=rfICDkj93WY)**
...
So If you don't know jack shit about first time setup then go over to [The Official VRChat Documentation](https://creators.vrchat.com/worlds/creating-your-first-world), [vrc.school](https://vrc.school), or find a [YouTube tutorial to help you out with that](https://youtu.be/0u1g0TYoJsU?si=5i304suvwThSiALP)(please don't fall into the tutorial hell before you even get started...please)
...
For Texturing I recommend using [GIMP](https://www.gimp.org), or [Affinity](https://www.affinity.studio/photo-editing-software)
...
As for what you can make in the world when it comes to programming, for starters, [how about a toggleable mirror?](https://www.youtube.com/watch?v=HylfkHcldaY&list=PLbZIA2BahzRXiWPA6QTGf3h18XSySYIDX&index=2)
...
you can do so by searching around [booth](https://booth.pm/), or any other marketplace
...
There are 2 routes that you can take with the Lighting Stage: [*The Bakery Route*](https://www.youtube.com/watch?v=toMvetpwOHU), or the [*Unity Lighting System Route*](https://www.youtube.com/watch?v=NOv31HSqs6U)
